    ...
    def __init__(
        ...
        if hparams.TRIAL.version == "real":
            ...
            if hparams.TRIAL.bedlam_bbox:
                ...
                self.smpl = SMPLXHead(focal_length=focal_length, img_res=img_res)

    def forward(
        self, images, bbox_scale=None, bbox_center=None, img_w=None, img_h=None, fl=None
    ):
        ...
        if self.hparams.TRIAL.bedlam_bbox:
            ...
            bbox_info[:, :2] = bbox_info[:, :2] / cam_intrinsics[:, 0, 0].unsqueeze(
                -1
            )  # [-1, 1]
