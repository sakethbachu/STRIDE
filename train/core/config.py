...
SMPL_MODEL_DIR = os.path.join(
    root_dir, "data/body_models/SMPL_python_v.1.1.0/smpl/models"
)  # @@@
SMPLX_MODEL_DIR = os.path.join(root_dir, "data/body_models/smplx/models/smplx")
MANO_MODEL_DIR = os.path.join(root_dir, "data/body_models/mano/mano_v1_2/models/")

JOINT_REGRESSOR_TRAIN_EXTRA = os.path.join(root_dir, "data/utils/J_regressor_extra.npy")
JOINT_REGRESSOR_H36M = os.path.join(root_dir, "data/utils/J_regressor_h36m.npy")
SMPL_MEAN_PARAMS = os.path.join(
    root_dir, "data/utils/smpl_mean_params.npz"
)  # @@'data/utils/smpl_mean_params.npz'
JOINT_REGRESSOR_14 = os.path.join(root_dir, "data/utils/SMPLX_to_J14.pkl")
SMPLX2SMPL = os.path.join(root_dir, "data/utils/smplx2smpl.pkl")
MEAN_PARAMS = os.path.join(root_dir, "data/utils/all_means.pkl")
DOWNSAMPLE_MAT_SMPLX_PATH = os.path.join(
    root_dir, "data/utils/downsample_mat_smplx.pkl"
)
...
hparams.MODEL.SHAPE_LOSS_WEIGHT = 0.0
hparams.MODEL.JOINT_LOSS_WEIGHT = 5.0
hparams.MODEL.KEYPOINT_LOSS_WEIGHT = 10.0
hparams.MODEL.POSE_LOSS_WEIGHT = 1.0
hparams.MODEL.BETA_LOSS_WEIGHT = 0.001
hparams.MODEL.LOSS_WEIGHT = 60.0
